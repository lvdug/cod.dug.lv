...
$view = new stdClass();
$view->name = 'cod_messages';
$view->description = 'Recent Messages';
$view->access = array (
);
$view->view_args_php = '';
$view->page = TRUE;
$view->page_title = 'Messages';
$view->page_header = '';
$view->page_header_format = '2';
$view->page_footer = '<?php print theme(\'conference_organizing_button\', t(\'Post message\'), \'node/add/discussion/\'.arg(1)); ?>';
$view->page_footer_format = '2';
$view->page_empty = 'No messages yet.
<?php print theme(\'conference_organizing_button\', t(\'Post message\'), \'node/add/discussion/\'.arg(1)); ?>';
$view->page_empty_format = '2';
$view->page_type = 'teaser';
$view->url = 'messages';
$view->use_pager = TRUE;
$view->nodes_per_page = '10';
$view->block = TRUE;
$view->block_title = 'Recent discussions';
$view->block_header = '';
$view->block_header_format = '1';
$view->block_footer = 'VIEW ALL';
$view->block_footer_format = '1';
$view->block_empty = '';
$view->block_empty_format = '1';
...
$view = new stdClass();
$view->name = 'cod_my_groups';
$view->description = 'My groups';
$view->access = array (
);
$view->view_args_php = '';
$view->page = TRUE;
...
$view->requires = array(node, og, og_uid, og_views);
$views[$view->name] = $view;
views_sanitize_view($view);
drupal_execute('views_edit_view', array(), $view, '');
