...
function cod_profile_modules() {
  return array(
    ...
    'content', 'date_api', 'date', 'views', 'views_ui', 'signup', 'uc_store', 'uc_product', 'uc_signup', 'flag', 'features', 'cod_session', 'cod_events', 'cod_attendees', 'cod_front_page', 'cod_news', 'cod_sponsors',
  );
}
